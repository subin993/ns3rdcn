...
//       std::string filename = "packet_log_solstice_64ports" + ip + ".txt";
...
for (std::size_t i = 0; i < nodePairs.size(); ++i) {
  ...
  flowMonitor->SerializeToXmlFile ("FlowMonitorData_p4_64ports_1G_mix_FB_x2.xml", true, true);
