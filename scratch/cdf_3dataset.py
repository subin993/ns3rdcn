...
plt.xticks([10**2, 10**3, 10**4, 10**5, 10**6, 10**7, 10**8, 10**9], 
           [r'$10^2$', r'$10^3$', r'$10^4$', r'$10^5$', r'$10^6$', r'$10^7$', r'$10^8$', r'$10^9$'], fontsize=22)
plt.yticks(fontsize=22)
# Adding titles and labels
# plt.title('CDF of Flow Sizes')
plt.xlabel('Flow size (bytes)', fontsize=24)
...
# Show plot
plt.show()
plt.savefig('flow_cdf_3datasets_wide.png', dpi=300, bbox_inches='tight')
